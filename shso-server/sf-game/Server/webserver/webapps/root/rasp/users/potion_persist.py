...
sys.path.append('/sfs/Server/webserver/webapps/root/rasp/users') 
import pylibcsp  
...
class potion_persist(HttpServlet): 
	...
	def doPost(self, request, response): 
		...
		sql = "select ownable_type_id, SfUserId, IF(Timestampdiff(SQL_TSI_MINUTE,start_timestamp,current_timestamp)>"+escapeQuotes(str(potionDuration))+",'T','F') FROM active_players, active_potion_effects WHERE userid="+escapeQuotes(str(userID))+";" 
