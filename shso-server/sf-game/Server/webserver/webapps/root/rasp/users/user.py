...
class user(HttpServlet):
	...
	def doPost(self, request, response):
        ...
        # outfile = open("/sfs/Server/webserver/webapps/root/rasp/inventoryresult.txt", "w")
		...
		reskins_sql = "select reskin_name, heroes.xp, heroes.tier, heroes.code from reskins, heroes where LOCATE(CONCAT(name, '_reskin'), reskin_name) != 0 AND UserID = " + escapeQuotes(userID)
