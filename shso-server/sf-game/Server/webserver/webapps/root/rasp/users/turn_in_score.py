...
def add_rewards_to_db(xp, fractals, user_id, hero, db):
	...
	if "_reskin" in hero and hero == 'carnage_playable_reskin_spider_carnage':
...
class turn_in_score(HttpServlet):
	...
	def doPost(self, request, response):
		...
		# 'bo_1002_1_Modok001':'Easy', # MODOK Mo' Problems!
		# 'ca_1001_1_Venom001':'Average', # Symbi-Oh No!
		# 'ca_1001_1_Venom001A':'Extra Long', # Symbi-Oh No! [CRISIS]
		# 'fl_1001_1_Bullseye001':'Easy', # Hit the Bullseye! (Please)
		...
		# 'm_100S_1_Skydome001A':'Survival Crisis', # Time to Take A.I.M.! [CRISIS]
		...
		# 'm_102S_1_Skydome003A':'Survival Crisis', # Asgardian Gladiators! [CRISIS]
		...
		# 'm_1032_1_Malekith001A':'Extra Long', # The Curse of Malekith! [CRISIS]
		...
		# 'm_103S_1_Skydome004A':'Survival Crisis', # Monster Smash! [CRISIS]
		...
		# 'm_104S_1_Skydome005A':'Survival Crisis', # Doomsday in Space! [CRISIS]
		# 'm_105S_1_Skydome006':'Survival', # When Titans Clash!
		# 'm_105S_1_Skydome006A':'Survival Crisis', # When Titans Clash! [CRISIS]
		# 'm_106S_1_Skydome007':'Survival', # To Battle The Brotherhood!
		# 'm_106S_1_Skydome007A':'Survival Crisis', # To Battle The Brotherhood! [CRISIS]
		...
		# 'x_1002_BaxterMiniMission': 'mayhem',
		# 'x_1001_AsgardMiniMission': 'mayhem',
		# 'm_999_1_Tutorial001': 'mayhem',
		# 'm_999_1_Tutorial002': 'mayhem',
		# 'm_0015_1_Tutorial_Brawler': 'mayhem',
		# }


		mission_classes = {
			'be_1001_1_RedSkull001':'Alert', # Skull and Void!
			'be_1001_1_RedSkull001A':'True Believer', # Skull and Void! [CRISIS]
			'bo_1001_1_Abomination001':'Trial', # Abomination Obliteration!
			'bo_1002_1_Modok001':'Patrol', # MODOK Mo' Problems!
			'ca_1001_1_Venom001':'Trial', # Symbi-Oh No!
			'ca_1001_1_Venom001A':'True Believer', # Symbi-Oh No! [CRISIS]
			'fl_1001_1_Bullseye001':'Trial', # Hit the Bullseye! (Please)
			'fl_1002_1_Kingpin001':'Alert', # Hail to the Kingpin?!
			'he_1001_1_Loki001':'Alert', # The Gods of Thunder?
			'he_1002_1_YmirSurtur001':'Alert', # Freezer Burn!
			'he_1003_1_Enchantress001':'Alert', # A Thousand Apples a Day
			'li_1002_1_Juggernaut001':'Alert', # All For Jugger-Naught
			'm_1001_1_DocOck001':'Trial', # Claw and Disorder!
			'm_1002_1_SuperSkrull001':'WIP', # Un-Secret Invasion!
			'm_1005_1_Magneto001':'WIP', # Super-Sized and Magnetized!
			'm_1006_1_DrDoom001':'Patrol', # Send In the Clone-Bots!
			'm_1006_1_DrDoom001A':'WIP', # Send In the Clone-Bots! [CRISIS]
			'm_1007_1_FingFangFoom001':'Trial', # Flame On! (And On And On And On)
			'm_1008_1_Ultron001':'Trial', # U Turned Out the Lights?!
			'm_1008_1_Ultron001A':'Ultimatum', # U Turned Out the Lights?! [CRISIS]
			'm_1009_1_GreenGoblin001':'Trial', # Bombs Away!
			'm_100S_1_Skydome001':'Survival', # Time to take A.I.M.!
			'm_100S_1_Skydome001A':'Survival Crisis', # Time to Take A.I.M.! [CRISIS]
			'm_100X_1_Sabretooth001':'Training', # Home Invasion!
			'm_1011_1_GreenGoblin002':'Alert', # Breezy Riders!
			'm_1012_1_SuperSkrull002':'WIP', # Unstoppa-Skrull!
			'm_1013_1_Mystique001':'Assignment', # Seeking Sneaky Mystique!
			'm_1013_1_Mystique001A':'Assignment', # Seeking Sneaky Mystique! [CRISIS]
			'm_1014_1_Annihilus001':'Trial', # Repellent Bugs
			'm_1015_1_SuperSkrull003':'WIP', # We Run in Peace
			'm_1016_1_DocOck002':'Trial', # Ock It to Me!
			'm_1017_1_Magneto002':'WIP', # Magneteors!
			'm_1018_1_FinFangFoom002':'Trial', # Very Bad Breath!
			'm_101S_1_Skydome002':'Survival', # Strike of the Spider-Foes!
			'm_101S_1_Skydome002A':'WIP', # Strike of the Spider-Foes! [CRISIS]
			'm_1020_1_MoleMan001':'Patrol', # Whack-a-Mole Man!
			'm_1022_1_Ultron001':'Trial', # Flat Broke and Rusted
			'm_1024_1_Lizard001':'Alert', # Lizard-ous to Your Health!
			'm_1025_1_Mysterio001':'WIP', # Mysterio's Things Are Afoot!
			'm_1025_1_Mysterio001A':'WIP', # Mysterio's Things Are Afoot! [CRISIS]
			'm_1026_1_Magneto003':'WIP', # Attack of the Iron Men!
			'm_1026_1_Magneto003A':'WIP', # Attack of the Iron Men! [CRISIS]
			'm_1027_1_Dracula001':'Trial', # Creatures of the Night!
			'm_1027_1_Dracula001A':'Operation', # Creatures of the Night! [CRISIS]
			'm_1028_1_Modok002':'Alert', # MODOK Madness!
			'm_1028_1_Modok002A':'Operation', # MODOK Madness! [CRISIS]
			'm_1029_1_Wendigo001':'Trial', # Wen-Di-Go Away!
			'm_1029_1_Wendigo001A':'Operation', # Wen-Di-Go Away! [CRISIS]
			'm_102S_1_Skydome003':'Survival', # Asgardian Gladiators!
			'm_102S_1_Skydome003A':'Survival Crisis', # Asgardian Gladiators! [CRISIS]
			'm_1031_1_TitaniumMan001':'Alert', # Extremis Measures!
			'm_1031_1_TitaniumMan001A':'WIP', # Extremis Measures! [CRISIS]
			'm_1032_1_Malekith001':'Alert', # The Curse of Malekith!
			'm_1032_1_Malekith001A':'Assignment', # The Curse of Malekith! [CRISIS]
			'm_1033_1_ImpossibleMan001':'Assignment', # The Impossible Holiday!
			'm_1033_1_ImpossibleMan001A':'Ultimatum', # The Impossible Holiday! [CRISIS]
			'm_1034_1_Villains001':'WIP', # Bring On The Bad Guys!
			'm_1034_1_Villains001A':'WIP', # Bring on The Bad Guys! [CRISIS]
			'm_1035_1_WinterSoldier001':'Alert', # Blast From The Past! 
			'm_1035_1_WinterSoldier001A':'Ultimatum', # Blast From The Past! [CRISIS] 
			'm_1036_1_SpiderMen001':'Alert', # Unfriendly Neighborhood Spider-Men!
			'm_1036_1_SpiderMen001A':'WIP', # Unfriendly Neighborhood Spider-Men! [CRISIS]
			'm_1037_1_Thanos001':'Trial', # The Infinite Thanos!
			'm_1037_1_Thanos001A':'True Believer', # The Infinite Thanos! [CRISIS]
			'm_1038_1_Deadpool001':'Patrol', # Deadpool's Scare-Tacular Adventure!
			'm_1038_1_Deadpool001A':'Operation', # Deadpool's Scare-Tacular Adventure! [CRISIS]
			'm_1039_1_ImpossibleMan002':'Trial', # Ho-Ho-Horrible!
			'm_1039_1_ImpossibleMan002A':'Operation', # Ho-Ho-Horrible! [CRISIS]
			'm_103S_1_Skydome004':'Survival', # Monster Smash!
			'm_103S_1_Skydome004A':'Survival Crisis', # Monster Smash! [CRISIS]
			'm_1040_1_MegaMission001':'WIP', # The Fight For Fractals!
			'm_1040_1_MegaMission001A':'WIP', # The Fight For Fractals! [CRISIS]
			'm_1041_1_MegaMission002':'WIP', # The Fight For Fractals Continues!
			'm_1041_1_MegaMission002A':'WIP', # The Fight For Fractals Continues! [CRISIS]
			'm_1042_1_MegaMission003':'Ultimatum', # The Final Fight For Fractals!
			'm_1042_1_MegaMission003A':'True Believer', # The Final Fight For Fractals [CRISIS]
			'm_104S_1_Skydome005':'Survival', # Doomsday in Space!
			'm_104S_1_Skydome005A':'Survival Crisis', # Doomsday in Space! [CRISIS]
			'm_105S_1_Skydome006':'Survival', # When Titans Clash!
			'm_105S_1_Skydome006A':'Survival Crisis', # When Titans Clash! [CRISIS]
			'm_106S_1_Skydome007':'Survival', # To Battle The Brotherhood!
			'm_106S_1_Skydome007A':'Survival Crisis', # To Battle The Brotherhood! [CRISIS]
			'ne_1001_1_Loki002':'Trial', # He's Baaack!
			'ni_1001_1_Dormammu001':'Alert', # Dormammu Mia!
			'ox_1001_1_Onslaught001':'Alert', # Onslaught Onslaught!
			'x_1002_BaxterMiniMission': 'mayhem',
			'x_1001_AsgardMiniMission': 'mayhem',
			'm_999_1_Tutorial001': 'mayhem',
			'm_999_1_Tutorial002': 'mayhem',
		...
		if mission_id in mission_classes and mission_classes[mission_id] != 'Survival' and mission_classes[mission_id] != 'Survival Crisis':
			multipliers = medal_multiplier + team_up_multiplier
		elif death_penalty >= (medal_multiplier + team_up_multiplier):
			multipliers = 1
		...
		if mission_id not in mission_classes:
			...
			mission_reward = round((int(score) / survivalDivider[mission_classes[mission_id]]) + 0.1)
		elif mission_classes[mission_id] == 'Survival Crisis':
			mission_reward = round((int(score) / survivalDivider[mission_classes[mission_id]]) + 0.1)
		elif mission_classes[mission_id] != 'Survival' and mission_classes[mission_id] != 'Survival Crisis':
		...
		if mission_id in mission_classes and mission_classes[mission_id] == 'Survival':
			if fractals > fractals_cap:
				fractals = fractals_cap
				xp = fractals * 3
		...
		# leaderboardInsertSQL = "INSERT INTO shso.leaderboard (UserID, MissionID, score, Hero, Multiplayer) VALUES (" + escapeQuotes(userID) + ", '" + escapeQuotes(mission_id) + "', " + escapeQuotes(score) + ", '" + escapeQuotes(heroName) + "', " + str(bool(int(squad_count) > 1)) + ") ON DUPLICATE KEY UPDATE Hero = IF(score < " + escapeQuotes(score) + " OR MONTH(CURRENT_TIMESTAMP) != timestamp, '" + escapeQuotes(heroName) + "', Hero), timestamp = IF(score < " + escapeQuotes(score) + " OR MONTH(CURRENT_TIMESTAMP) != timestamp, CURRENT_TIMESTAMP, timestamp), score = IF(score < " + escapeQuotes(score) + " OR MONTH(CURRENT_TIMESTAMP) != timestamp, " + escapeQuotes(score) + ", score);"
		leaderboardInsertSQL = "INSERT INTO shso.leaderboard (UserID, MissionID, score, Hero, Multiplayer) VALUES (" + escapeQuotes(userID) + ", '" + escapeQuotes(mission_id) + "', " + escapeQuotes(score) + ", '" + escapeQuotes(heroName) + "', " + str(bool(int(squad_count) > 1)) + ");"
